!(function (e, t) {
        ...
        function (e, t, n, i) {
          ...
          if (((n = n || []), 1 === c.length)) {
            if (
              ...
              if (!(t = (_.find.ID(s.matches[0].replace(Z, ee), t) || [])[0]))
                return n;
  ...
  (C.filter = function (e, t, n) {
    ...
    C.fn.extend({
      ...
      is: function (e) {
        return !!I(this, "string" == typeof e && A.test(e) ? C(e) : e || [], !1)
          .length;
      },
    });
  var k,
  ...
  (ge = x.createDocumentFragment().appendChild(x.createElement("div"))),
  ...
  function He(n, i, r, o) {
    ...
    if (
      ...
      for (a = (s = C.map(de(e, "script"), Oe)).length; c < f; c++)
        (l = e),
          c !== h &&
            ((l = C.clone(l, !0, !0)), a && C.merge(s, de(l, "script"))),
          r.call(n[c], l, c);
      if (a)
          ...
          (l = s[c]),
            fe.test(l.type || "") &&
              ...
              (l.src && "module" !== (l.type || "").toLowerCase()
                ...
                : _(l.textContent.replace(Ie, ""), u, l));
    }
    return n;
  }
  function Pe(e, t, n) {
    for (var i, r = t ? C.filter(t, e) : e, o = 0; null != (i = r[o]); o++)
      n || 1 !== i.nodeType || C.cleanData(de(i)),
        i.parentNode &&
          (n && C.contains(i.ownerDocument, i) && pe(de(i, "script")),
    ...
    C.fn.extend({
      ...
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++)
          1 === e.nodeType && (C.cleanData(de(e, !1)), (e.textContent = ""));
        return this;
      },
      clone: function (e, t) {
        return (
          ...
          function (e) {
            ...
            if (
              ...
              try {
                for (; n < i; n++)
                  1 === (t = this[n] || {}).nodeType &&
                    (C.cleanData(de(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (e) {}
            }
      ...
      replaceWith: function () {
        ...
        return He(
          ...
          function (e) {
            ...
            C.inArray(this, n) < 0 &&
              (C.cleanData(de(this)), t && t.replaceChild(e, this));
          },
          n
        );
      },
  ...
  C.extend({
    ...
    C.each(["height", "width"], function (e, a) {
      C.cssHooks[a] = {
        get: function (e, t, n) {
          if (t)
            return !Be.test(C.css(e, "display")) ||
        ...
        return (
          ...
          i ||
            ...
            (l &&
              ...
              ((s = n[l]) && (n[l] = null),
              (C.event.triggered = d),
              e.isPropagationStopped() && f.addEventListener(d, bt),
              n[d](),
              e.isPropagationStopped() && f.removeEventListener(d, bt),
        ...
        m.hasContent
          ...
          : ((o = m.url.slice(f.length)),
            m.data &&
              ...
              ((f += (Et.test(f) ? "&" : "?") + m.data), delete m.data),
            !1 === m.cache &&
              ((f = f.replace(It, "$1")),
              (o = (Et.test(f) ? "&" : "?") + "_=" + wt++ + o)),
            (m.url = f + o)),
  ...
  C.ajaxSetup({
    ...
    C.each(["top", "left"], function (e, n) {
      C.cssHooks[n] = Fe(v.pixelPosition, function (e, t) {
        if (t)
          return (t = We(e, n)), qe.test(t) ? C(e).position()[n] + "px" : t;
      });
    }),
  ...
  (function (e, t) {
        ...
        return (
          ...
          (o._jQueryInterface = function (i) {
            return this.each(function () {
              ...
              if (
                (e || ((e = new o(this, t)), p(this).data(L, e)),
                "number" == typeof i)
              )
                e.to(i);
                  ...
                  for (var r = 0; r < i; r++) {
                    ...
                    if (null !== s)
                      p([].slice.call(document.querySelectorAll(s))).hasClass(
                        ge
                      ) || p(o).addClass(ye).attr("aria-expanded", !1);
                  }
                this.setTransitioning(!0);
                this._element.style[n] = "";
    ...
    for (
      var xe = "undefined" != typeof window && "undefined" != typeof document,
    ...
    function Pe(e) {
      ...
      for (
        var t = He(10) ? document.body : null, n = e.offsetParent || null;
                ...
                _.forEach(function (e, t) {
                  ...
                  (s || f || d) &&
                    ...
                    (p.offsets.popper = Qe(
                      {},
                      p.offsets.popper,
                      tt(p.instance.popper, p.offsets.reference, p.placement)
                    )),
          ...
          computeStyle: {
            ...
            fn: function (e, t) {
              ...
              var s,
                ...
                y,
                b,
                _ = void 0 !== o ? o : t.gpuAcceleration,
              ...
              return (
                (e.attributes = Qe({}, O, e.attributes)),
          ...
          applyStyle: {
            ...
            onLoad: function (e, t, n, i, r) {
              ...
              return (
                ...
                ct(t, { position: n.positionFixed ? "fixed" : "absolute" }),
                n
              );
            },
      ...
      wt = (function () {
        function o(e, t) {
          ...
          !(function (e, t) {
            ...
            Object.keys(Qe({}, o.Defaults.modifiers, i.modifiers)).forEach(
              function (e) {
                n.options.modifiers[e] = Qe(
                  {},
      ...
      Yt = (function () {
        ...
        return (
          ...
          (e._getPlacement = function () {
            ...
            return (
              e.hasClass(kt)
                ? ((t = Ft), p(this._menu).hasClass(jt) && (t = Bt))
                : e.hasClass(Ot)
                ? (t = Qt)
                : e.hasClass(Lt)
                ? (t = $t)
                : p(this._menu).hasClass(jt) && (t = zt),
              t
            );
          }),
    ...
    p(document)
      .on(Dt.KEYDOWN_DATA_API, Pt, Yt._dataApiKeydownHandler)
      .on(Dt.KEYDOWN_DATA_API, Rt, Yt._dataApiKeydownHandler)
      .on(Dt.CLICK_DATA_API + " " + Dt.KEYUP_DATA_API, Yt._clearMenus)
        ...
        return (
          ...
          (r._jQueryInterface = function (n, i) {
            return this.each(function () {
              ...
              if (
                (e || ((e = new r(this, t)), p(this).data(Gt, e)),
                "string" == typeof n)
              ) {
                if (void 0 === e[n])
                  throw new TypeError('No method named "' + n + '"');
            ...
            r.forEach(function (e) {
              (function (e, t) {
                ...
                if (-1 !== t.indexOf(n))
                  return (
                    -1 === vn.indexOf(n) ||
                    Boolean(e.nodeValue.match(bn) || e.nodeValue.match(_n))
                  );
                for (
        ...
        return (
            ...
            "object" != typeof t || (!t.nodeType && !t.jquery)
              ? this.config.html
                ? (this.config.sanitize &&
                    (t = wn(t, this.config.whiteList, this.config.sanitizeFn)),
                  e.html(t))
                : e.text(t)
              : this.config.html
          ...
          (e._getConfig = function (e) {
            ...
            return (
              ...
              e.sanitize &&
                (e.template = wn(e.template, e.whiteList, e.sanitizeFn)),
              e
            );
          }),
          ...
          (i._jQueryInterface = function (n) {
            return this.each(function () {
              ...
              if (
                ...
                (e || ((e = new i(this, t)), p(this).data(Tn, e)),
                "string" == typeof n)
              ) {
                if (void 0 === e[n])
                  throw new TypeError('No method named "' + n + '"');
        ...
        return (
          ...
          (i._jQueryInterface = function (n) {
            return this.each(function () {
              ...
              if (
                (e || !/dispose|hide/.test(n)) &&
                (e || ((e = new i(this, t)), p(this).data(Qn, e)),
                "string" == typeof n)
              ) {
                if (void 0 === e[n])
                  throw new TypeError('No method named "' + n + '"');
      ...
      Ti = (function () {
        ...
        return (
          ...
          (e._getConfig = function (e) {
            if (
              "string" !=
              typeof (e = l({}, li, "object" == typeof e && e ? e : {})).target
            ) {
              var t = p(e.target).attr("id");
              t || ((t = g.getUID(ri)), p(e.target).attr("id", t)),
                (e.target = "#" + t);
            }
          ...
          (e._activate = function (t) {
            ...
            n.hasClass(fi)
              ? (n.closest(yi).find(_i).addClass(hi), n.addClass(hi))
              : (n.addClass(hi),
                n
                  .parents(pi)
                  .prev(gi + ", " + vi)
    ...
    p(window).on(ci.LOAD_DATA_API, function () {
      for (
        var e = [].slice.call(document.querySelectorAll(di)), t = e.length;
        t--;
        ...
        return (
          (e.show = function () {
            ...
            if (
              ...
              var s = p.Event(Ai.HIDE, { relatedTarget: this._element }),
                a = p.Event(Ai.SHOW, { relatedTarget: i });
              if (
                (i && p(i).trigger(s),
                ...
                var l = function () {
                  var e = p.Event(Ai.HIDDEN, { relatedTarget: n._element }),
                    t = p.Event(Ai.SHOWN, { relatedTarget: i });
          ...
          (i._jQueryInterface = function (n) {
            return this.each(function () {
              var e = p(this),
                t = e.data(xi);
              if (
                (t || ((t = new i(this)), e.data(xi, t)), "string" == typeof n)
              ) {
                if (void 0 === t[n])
                  throw new TypeError('No method named "' + n + '"');
                t[n]();
        ...
        return (
          this.each(function () {
            ...
            if (h.parent().hasClass(A.wrapperClass)) {
              var d = h.scrollTop();
              if (
                ((b = h.siblings("." + A.barClass)),
                (y = h.siblings("." + A.railClass)),
                T(),
                D.isPlainObject(S))
              ) {
                ...
                if ("scrollTo" in S) d = parseInt(A.scrollTo);
                  ...
                  return b.remove(), y.remove(), void h.unwrap();
                E(d, !1, !0);
              }
              ...
              h.css({ overflow: "hidden", width: A.width, height: A.height });
              var v,
                y = D(u)
              ...
              y.css(_),
                ...
                T(),
                "bottom" === A.start
                  ? (b.css({ top: h.outerHeight() - b.outerHeight() }),
                    E(0, !0))
                  : "top" !== A.start &&
                    (E(D(A.start).position().top, null, !0),
            ...
            function E(e, t, n) {
              ...
              if (
                (t &&
                  ((i =
                    parseInt(b.css("top")) +
                    ((e * parseInt(A.wheelStep)) / 100) * b.outerHeight()),
                ...
                (i =
                  (a =
                    parseInt(b.css("top")) /
                    (h.outerHeight() - b.outerHeight())) *
                  (h[0].scrollHeight - h.outerHeight())),
                n)
              ) {
                var o = ((i = e) / h[0].scrollHeight) * h.outerHeight();
                (o = Math.min(Math.max(o, 0), r)), b.css({ top: o + "px" });
              }
              h.scrollTop(i), h.trigger("slimscrolling", ~~i), x(), C();
            }
            function T() {
              (s = Math.max(
                (h.outerHeight() / h[0].scrollHeight) * h.outerHeight(),
                c
              )),
                b.css({ height: s + "px" });
  ...
  (function (e, t) {
    ...
    return (
        ...
        return (
          (e.init = function () {
            var o = this,
              s = this.config;
            a(this.element)
              .find(s.parentTrigger + "." + s.activeClass)
              .has(s.subMenu)
              .children(s.subMenu)
              .addClass(s.collapseClass + " " + s.collapseInClass),
              a(this.element)
                .find(s.parentTrigger)
                .not("." + s.activeClass)
                .has(s.subMenu)
                .children(s.subMenu)
                .addClass(s.collapseClass),
              a(this.element)
                .find(s.parentTrigger)
                .has(s.subMenu)
                ...
                .on(u.CLICK_DATA_API, function (e) {
                  ...
                  s.preventDefault && e.preventDefault(),
                    "true" !== t.attr("aria-disabled") &&
                      (n.hasClass(s.activeClass)
                        ? (t.attr("aria-expanded", !1), o.hide(r))
                        : (o.show(r),
                          t.attr("aria-expanded", !0),
                          s.toggle && i.attr("aria-expanded", !1)),
          ...
          (e.show = function (e) {
            ...
            if (
              !this.transitioning &&
              !a(e).hasClass(this.config.collapsingClass)
            ) {
              var n = a(e),
                i = a.Event(u.SHOW);
                  ...
                  .one(c.TRANSITION_END, function () {
                    t.config &&
                      ...
                      (n
                        ...
                        .addClass(
                          t.config.collapseClass +
                            " " +
                            t.config.collapseInClass
                        )
                        .height(""),
          ...
          (e.hide = function (e) {
            ...
            if (
              !this.transitioning &&
              a(e).hasClass(this.config.collapseInClass)
            ) {
              var n = a(e),
                i = a.Event(u.HIDE);
              if ((n.trigger(i), !i.isDefaultPrevented())) {
      ...
      (a.fn[t] = r.jQueryInterface),
      (a.fn[t].Constructor = r),
  ...
  (function (e, t) {
    ...
    function f(e) {
      ...
      return (
        ...
        (n =
          null !== (r = i = s) && r === r.window
            ? i
            : 9 === i.nodeType && i.defaultView),
        {
    ...
    var d = {
        ...
        show: function (e, t, n) {
            ...
            (s =
              "touches" in e && e.touches.length
                ? ((o = e.touches[0].pageY - r.top),
                  e.touches[0].pageX - r.left)
                : ((o = e.pageY - r.top), e.pageX - r.left))
              ? s
              : 0),
            (o = 0 <= o ? o : 0);
          ...
          var u = { top: o + "px", left: s + "px" };
          i.classList.add("waves-notransition"),
            i.setAttribute("style", h(u)),
        ...
        hide: function (e, t) {
          for (
            ...
            o(e, t, n[i]);
          a &&
            (t.removeEventListener("touchend", d.hide),
            t.removeEventListener("touchcancel", d.hide)),
            t.removeEventListener("mouseup", d.hide),
            t.removeEventListener("mouseleave", d.hide);
        },
      },
      l = {
        input: function (e) {
    ...
    var u = {
      ...
      allowEvent: function (e) {
        var t = !0;
        return (
          /^(mousedown|mousemove)$/.test(e.type) && u.touches && (t = !1), t
        );
      },
      ...
      if (null !== n) {
        ...
        if ((u.registerEvent(t), "touchstart" === t.type && d.delay)) {
          var i = !1,
            ...
            o = function (e) {
              r && (clearTimeout(r), (r = null), d.show(t, n)),
                i || ((i = !0), d.hide(e, n)),
                s();
            },
            e = function (e) {
          ...
          d.show(t, n),
            a &&
              (n.addEventListener("touchend", d.hide, !1),
              n.addEventListener("touchcancel", d.hide, !1)),
            n.addEventListener("mouseup", d.hide, !1),
            n.addEventListener("mouseleave", d.hide, !1);
      }
    }
    return (
      (t.init = function (e) {
        var t = document.body;
        "duration" in (e = e || {}) && (d.duration = e.duration),
          "delay" in e && (d.delay = e.delay),
          a &&
        ...
        if (
          ...
          for (
            ...
            if (
              ...
              setTimeout(u({ type: "mouseup", button: 1 }, i), t.wait);
            }
      }),
      (t.calm = function (e) {
        for (
          var t = { type: "mouseup", button: 1 }, n = 0, i = (e = c(e)).length;
          n < i;
          n++
        )
          d.hide(t, e[n]);
  ...
  (function () {
    ...
    function n(e) {
      (this.element = e),
        ...
        (i += 1),
        m.windowContext ||
          ((m.windowContext = !0), (m.windowContext = new n(window))),
        ...
        (e = {
          ...
          for (var s in this.waypoints[r]) {
            ...
            f.element !== f.element.window &&
              ...
              (f.triggerPoint = Math.floor(p + a - h)),
              (l = d < o.oldScroll),
              (u = f.triggerPoint >= o.oldScroll),
              (c = !l && !u),
              !g && l && u
                ? (f.queueTrigger(o.backward), (i[f.group.id] = f.group))
                : !g && c
        ...
        d.waypoint(
          function (e) {
            !(function () {
              var e = [],
                t = p.time / p.delay,
                n = v(this).attr("data-num")
                  ? v(this).attr("data-num")
                  : d.text(),
                i = /[0-9]+,[0-9]+/.test(n),
              ...
              d.data("counterup-func", function () {
                d.data("counterup-nums")
                  ? (d.html(d.data("counterup-nums").shift()),
                    d.data("counterup-nums").length
                      ? setTimeout(d.data("counterup-func"), p.delay)
                      : (d.data("counterup-nums", null),
                        d.data("counterup-func", null),
          ...
          { offset: p.offset + "%", context: p.context }
        );
      });
    };
  })(jQuery);
