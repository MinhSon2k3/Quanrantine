...
(function () {
    ...
    CKEDITOR.tools = {
      ...
      extend: function (a) {
        ...
        for (var h = 1; h < f; h++) {
          var d = arguments[h],
            m;
          for (m in d)
            if (!0 === b || null == a[m]) if (!c || m in c) a[m] = d[m];
        }
        return a;
      },
          ...
          var d = f,
            f = function () {
              ...
              for (f in c) {
                var b = c[f];
                a[f] =
                  "function" == typeof b ? CKEDITOR.tools.bind(b, this) : b;
              }
      ...
      keystrokeToString: function (a, b) {
        var c = b & 16711680,
          ...
          m = [];
        c & CKEDITOR.CTRL &&
          (p.push(d ? "⌘" : a[17]), m.push(d ? a[224] : a[17]));
  ...
  CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
    ...
    getIndex: function (a) {
      function d(a, c) {
        ...
        return p && p.nodeType == CKEDITOR.NODE_TEXT
          ? b(p)
            ? d(p, c)
            : p
          : null;
    ...
    getAscendant: function (a, d) {
      ...
      for (; b; ) {
        if (c(e ? new CKEDITOR.dom.node(b) : b))
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
      ...
      getAttributes: function (a) {
        ...
        for (f = 0; f < c.length; f++)
          -1 === CKEDITOR.tools.indexOf(a, c[f].name) &&
            (b[c[f].name] = c[f].value);
        return b;
      },
      ...
      scrollIntoParent: function (a, b, c) {
        ...
        a instanceof CKEDITOR.dom.window &&
          (a = k ? e.getBody() : e.getDocumentElement());
        CKEDITOR.env.webkit &&
          (e = this.getEditor(!1)) &&
      ...
      copyAttributes: function (a, b) {
        ...
        for (var f = 0; f < c.length; f++) {
          var d = c[f],
            ...
            g;
          if (!(e in b))
            if ("checked" == e && (g = this.getAttribute(e)))
              a.setAttribute(e, g);
        ...
        : (a
            ...
            : ((f = d),
              f.type == CKEDITOR.NODE_ELEMENT &&
                ((f = f.getChild(e)) ||
                  (f =
                    !1 === g(d, !0) ? null : d.getNextSourceNode(!0, q, g)))),
          f && !1 === g(f) && (f = null));
      for (; f && !this._.end; ) {
        this.current = f;
    ...
    CKEDITOR.dom.range.prototype = {
        ...
        switch (a) {
          ...
          case CKEDITOR.ENLARGE_ELEMENT:
            ...
            for (l = c(l); l || q; ) {
              ...
              for (; q; )
                if (((A = !1), q.type == CKEDITOR.NODE_COMMENT))
                  q = q.getPrevious();
                else {
                    ...
                    if (t && CKEDITOR.dtd.$removeEmpty[q.getName()]) {
                      ...
                      if (d.test(C)) q = null;
                        ...
                        for (
                          ...
                          if (
                            !CKEDITOR.dtd.$removeEmpty[H.nodeName.toLowerCase()]
                          ) {
                            q = null;
                            break;
                          }
      ...
      splitBlock: function (a, b) {
        ...
        "br" != a &&
          (e ||
            ((e = this.fixBlock(!0, a)),
            (m = new CKEDITOR.dom.elementPath(this.endContainer, this.root)
              .block)),
        ...
        e &&
          e.equals(m) &&
          (d
            ? ((g = new CKEDITOR.dom.elementPath(
                this.startContainer,
                this.root
              )),
        ...
        for (this._.nextNode = null; x; ) {
          ...
          if (F) x.type == CKEDITOR.NODE_TEXT && e.test(x.getText()) && (F = 0);
            ...
            if (
              ...
              x.isBlockBoundary(this.forceBrBreak && !w && { br: 1 })
            ) {
              if ("br" == q) F = 1;
          ...
          !x.equals(k.root)
            ...
            : u ||
              (this._.nextNode = d.equals(m)
                ? null
                : this._getNextSourceNode(k.getBoundaryNodes().endNode, 1, m));
        }
        z &&
          (z = d.getPrevious()) &&
  ...
  (function () {
    function a(a, b, c, d, l) {
      ...
      for (e in b) {
        ...
        for (t in Q) {
          ...
          for (C in v)
            "!" == C.charAt(0) &&
              ((C = C.slice(1)), A.push(C), (E[C] = !0), (I = !1));
      ...
      for (d = a.length; c < d; ++c) {
        ...
        if (!0 === e.elements || null === e.elements)
          l[q ? "unshift" : "push"](e);
        else
    ...
    function c(a, b, c) {
      if (!a.match || a.match(b)) {
        ...
        c.hadInvalidAttribute =
          e(a.attributes, b.attributes) || c.hadInvalidAttribute;
      ...
      if ((l = a.requiredClasses))
        for (e = b.classes, c = 0; c < l.length; ++c)
          if (((d = l[c]), "string" == typeof d)) {
            ...
            return !1;
      return (
        p(b.styles, a.requiredStyles) && p(b.attributes, a.requiredAttributes)
      );
    }
    function p(a, b) {
      if (!b) return !0;
    ...
    function F(a) {
      return (
        a.type == CKEDITOR.NODE_ELEMENT && ("br" == a.name || D.$block[a.name])
      );
    }
    function l(a, b, c) {
      var d = a.name;
      if (D.$empty[d] || !a.children.length)
        ...
        if ("br" == b)
          ...
          if (l)
            ...
            for (
              var e =
                  l.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == l.name,
                t,
                f,
                q = d.length;
              0 < q;
    ...
    function q(a, b, c) {
      ...
      for (d = 0; d < c.length; ++d)
        if (
          ((l = c[d]),
          !((l.check && !a.check(l.check, !1)) || (l.left && !l.left(b))))
        ) {
          l.right(b, K);
          break;
        }
    ...
    function n(a, b) {
      ...
      for (e in d)
        if ("class" == e)
          for (
            c = d[e].split(/\s+/), n = a.classes.join("|");
            (t = c.pop());
      ...
      if (a instanceof CKEDITOR.editor) {
        ...
        !0 === b
          ...
          : (b || (this.customConfig = !1),
            ...
            this.allow(
              R[a.enterMode] + " " + R[a.shiftEnterMode],
              "default",
              1
            ),
      ...
      transform: function (a, b) {
        if ("string" == typeof b) a.name = b;
          ...
          for (e in l)
            if ("class" == e)
              for (
                c = a.classes.join("|"), n = l[e].split(/\s+/);
                (t = n.pop());
    ...
    function B(a) {
      ...
      CKEDITOR.plugins.load(c.split(","), function (c) {
        ...
        CKEDITOR.scriptLoader.load(e, function () {
          for (
            var c = ["beforeInit", "init", "afterInit"], e = 0;
            e < c.length;
            e++
          )
    ...
    CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(
      new CKEDITOR.htmlParser.node(),
      {
        ...
        getFilterContext: function (a) {
          ...
          a.off ||
            "off" != this.attributes["data-cke-processor"] ||
            b.push("off", !0);
    ...
    m = (function () {
      ...
      function f(b) {
        return (
          b &&
          a(b) &&
          (b.is(p.$removeEmpty) || (b.is("a") && !b.isBlockBoundary()))
        );
      }
      function g(b, c, d, e) {
        var f = b.clone(),
      ...
      return function (m, v, G, E) {
        ...
        if (!E.checkReadOnly()) {
          var L =
            new CKEDITOR.dom.elementPath(E.startContainer, E.root).blockLimit ||
            E.root;
          m = {
            type: v,
            dontFilter: K,
                ...
                L.hasBlockSibling
                  ...
                  ? ((aa = U.getPosition(F)),
                    ...
                    aa == CKEDITOR.POSITION_CONTAINS
                      ? (y = 0)
                      : ((F = y.splitElement(U)),
                        y.moveToPosition(F, CKEDITOR.POSITION_AFTER_START),
                        (y = 1)))
                  : (y = 0);
              }
              if (y) G = 0 < E;
      ...
      return {
        list: {
          detectMerge: function (a, b) {
            ...
            a.mergeList =
              l && g && l.getParent().equals(g.getParent()) && !l.equals(g);
            a.mergeListItems =
              e.block &&
              f.block &&
              e.block.is(CKEDITOR.dtd.$listItem) &&
  ...
  (function () {
    function a() {
      ...
      a &&
        ...
        (b && b.isHidden()) || (a.reset(), (a = 0)));
      if (
        !a &&
        ((a = b || this.getSelection(1)),
        !a || a.getType() == CKEDITOR.SELECTION_NONE)
      )
        return;
      ...
      e.on("contentDom", function () {
        ...
        function c() {
          ...
          var a = CKEDITOR.document.$.selection,
            b = a.createRange();
          "None" != a.type &&
            b.parentElement().ownerDocument == f.$ &&
            b.select();
        }
        var f = e.document,
          l = CKEDITOR.document,
        ...
        g.attachListener(
          ...
          function () {
            p &&
              ...
              (p =
                e._.previousActive &&
                e._.previousActive.equals(f.getActive())) &&
        ...
        if (m && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
          ...
          g.attachListener(
            CKEDITOR.env.ie ? g : f.getDocumentElement(),
            "mouseup",
            d,
            e
          );
      ...
      CKEDITOR.on("instanceReady", function (a) {
        ...
        b.on(
          ...
          function () {
            ...
            c &&
              (c.getCustomData("ready") ? k(a) : c.setCustomData("ready", 1));
          },
          null,
          null,
          -1
        ...
        var a = B
          ? (function () {
              ...
              var b = function (b, c) {
                ...
                return {
                  container: m,
                  offset: 0 < n ? -g : m.nodeValue.length + g,
                };
              };
              return function () {
  ...
  (function () {
    ...
    function c(a) {
      ...
      if (a.collapsed) {
        for (
          var e = new CKEDITOR.dom.elementPath(d.getParent(), a.root),
            f,
            g = 0,
            h;
          g < e.elements.length &&
    ...
    function t(a, b, c) {
      ...
      for (var f, g = e.createIterator(); (f = g.getNextRange()); )
        b.call(this, f, c);
      a.selectRanges(e);
    ...
    CKEDITOR.style.prototype = {
      apply: function (a) {
        if (a instanceof CKEDITOR.dom.document)
          return t.call(this, a.getSelection());
      ...
      remove: function (a) {
        if (a instanceof CKEDITOR.dom.document)
          return t.call(this, a.getSelection(), 1);
        if (this.checkApplicable(a.elementPath(), a)) {
          var b = this._.enterMode;
          b || (this._.enterMode = a.activeEnterMode);
      ...
      do
        if (p.type == CKEDITOR.NODE_ELEMENT) {
          ...
          if (
            !this.lastElement &&
            ((this.lastElement = p),
            p.is(CKEDITOR.dtd.$object) ||
              "false" == p.getAttribute("contenteditable"))
          )
            continue;
          if (p.equals(e)) break;
          if (
      ...
      setUiColor: function (a) {
        ...
        return (this.setUiColor = function (a) {
          ...
          var c = CKEDITOR.skin.chameleon,
            ...
            g = "";
          "function" == typeof c &&
            ((d = c(this, "editor")), (g = c(this, "panel")));
          a = [[p, a]];
          e([b], d, a);
          e(h, g, a);
        }).call(this, a);
...
*/
  ...
  (function () {
    ...
    CKEDITOR.dialog.prototype = {
      ...
      layout: function () {
        ...
        CKEDITOR.env.ie6Compat ||
          (b.height + (0 < d ? d : 0) > c.height ||
          b.width + (0 < e ? e : 0) > c.width
    ...
    function z(b) {
      ...
      function n(a, c) {
        ...
        if (!d.getById("cke_pastebin")) {
          ...
          setTimeout(function () {
            CKEDITOR.env.webkit &&
              (CKEDITOR.document.getBody().$.scrollTop = r);
            h && h.removeListener();
      ...
      function w() {
        ...
        a.lock();
        if (b.editable().fire(m.mainPasteEvent) && !d("paste"))
          return a.unlock(), !1;
        a.unlock();
        return !0;
      }
      ...
      function u(a) {
        var c = {
          type: "auto",
          method: "paste",
          dataTransfer: m.initPasteDataTransfer(a),
        };
        ...
        d.attachListener(
          ...
          function () {
            ...
            CKEDITOR.env.ie &&
              ...
              ((a.dragStartContainerChildCount = d
                ? g(d.startContainer)
                : null),
    ...
    CKEDITOR.plugins.clipboard = {
      ...
      isDropRangeAffectedByDragRange: function (b, a) {
        ...
        return (b.endContainer.equals(c) && b.endOffset <= e) ||
          (b.startContainer.getParent().equals(c) &&
            b.startContainer.getIndex() < e) ||
          (b.endContainer.getParent().equals(c) &&
            b.endContainer.getIndex() < e)
          ? !0
          : !1;
      },
      internalDrop: function (b, a, c, e) {
        ...
        (h = this.isDropRangeAffectedByDragRange(b, a)) ||
          (d = b.createBookmark(!1));
      ...
      getRangeAtDropPosition: function (b, a) {
        ...
        if (document.caretRangeFromPoint)
          ...
          d.setStart(CKEDITOR.dom.node(c.rangeParent), c.rangeOffset),
            d.collapse(!0);
        else {
          if (
            CKEDITOR.env.ie &&
      ...
      initPasteDataTransfer: function (b, a) {
        ...
        return new this.dataTransfer(
          (CKEDITOR.env.edge && b && b.data.$ && b.data.$.clipboardData) ||
            null,
          a
        );
      },
                    ...
                    if (t) {
                      ...
                      if (t.type == CKEDITOR.UI_SEPARATOR) k = e && t;
                        ...
                        if (!n) {
                          ...
                          var u = q.push(n) - 1;
                          0 < u &&
                            ((n.previous = q[u - 1]), (n.previous.next = n));
                        }
                        A
                          ? e ||
                            (b.push(
                ...
                : ((b =
                  ...
                  CKEDITOR.env.needsBrFiller
                    ? (f.createText("﻿").insertAfter(b),
                      ...
                      (b.getNext().$.nodeValue = ""),
                      a.setStartAt(b.getNext(), CKEDITOR.POSITION_AFTER_START))
      ...
      proto: {
        ...
        getData: function (a) {
          ...
          var f = a.config,
            ...
            e = this.getDocument(),
            b = b
              ? e.getDocumentElement().getOuterHtml()
              : e.getBody().getHtml();
          CKEDITOR.env.gecko &&
  ...
  (function () {
    function w(c) {
      function f(b) {
        for (
          var e = d.startContainer, a = d.endContainer;
        ...
        for (
          ...
          if (((k[a].indent += g), 0 < g)) {
            var h = k[a].parent;
            k[a].parent = new CKEDITOR.dom.element(
              h.getName(),
              h.getDocument()
            );
          }
  ...
  (function () {
    function I(b, m, e) {
      ...
      for (
        ...
        (h = h.getAscendant("li", !0)) &&
          ...
          (g.push(h),
          CKEDITOR.dom.element.setMarker(e, h, "list_item_processed", !0));
      }
      h = null;
      ...
      for (k = h + 1; k < f.length; k++)
        if (f[k].indent > f[k - 1].indent + 1) {
          ...
          for (h = f[k].indent; f[k] && f[k].indent >= h; )
            (f[k].indent += g), k++;
          k--;
        }
    ...
    function E(b, m, e, c) {
      for (var f, g; (f = b[c ? "getLast" : "getFirst"](J)); )
        (g = f.getDirection(1)) !== m.getDirection(1) &&
          f.setAttribute("dir", g),
          f.remove(),
    ...
    function G(b) {
      return (
        b.type == CKEDITOR.NODE_ELEMENT &&
        (b.getName() in CKEDITOR.dtd.$block ||
    ...
    function C(b, m, e) {
      ...
      k
        ...
        : h && (k = h.getPrevious(u)) && z(k) && k.remove();
      (k = c.getLast()) &&
        k.type == CKEDITOR.NODE_ELEMENT &&
        k.is("br") &&
        k.remove();
      ...
      d &&
        (c = A(d)) &&
        (g.contains(d) ? (E(c, d.getParent(), d), c.remove()) : g.append(c));
      ...
      listToArray: function (b, m, e, c, f) {
        ...
        for (var g = 0, k = b.getChildCount(); g < k; g++) {
          ...
          if ("li" == h.$.nodeName.toLowerCase()) {
            ...
            m &&
              CKEDITOR.dom.element.setMarker(m, h, "listarray_index", e.length);
            e.push(d);
    ...
    B.prototype = {
      ...
      refresh: function (b, m) {
        ...
        e && c.contains(e)
          ? this.setState(
              e.is(this.type) ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF
            )
          : this.setState(CKEDITOR.TRISTATE_OFF);
      },
    };
  ...
  CKEDITOR.config.plugins =
    "dialogui,dialog,about,basicstyles,clipboard,button,toolbar,enterkey,entities,floatingspace,wysiwygarea,indent,indentlist,fakeobjects,link,list,undo";
