                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">View Medication List</li>
                                    </ol>
                                </div>
                            ...
                            <div class="card-box">
                                ...
                                <div class="table-responsive">
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                        ...
                                        <tbody>
                                            <?php
                                            $ret = "SELECT m.Medication_ID, m.Effects, m.Medication_Name, m.Medication_Code, m.Price, m.Patient_ID, 
                                                                CONCAT(p.Patient_ID, ':', p.Full_Name) AS PatientInfo,
                                                                t.Test_ID, CONCAT(t.Test_ID, ':', t.Test_Type) AS TestInfo
                                                        FROM medication m
                                                        LEFT JOIN patient p ON m.Patient_ID = p.Patient_ID
                                                        LEFT JOIN test t ON m.Test_ID = t.Test_ID
                                                        ORDER BY RAND()";
